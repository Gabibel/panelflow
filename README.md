...
| Path | What | Status |
|---|---|---|
| `/backend` | Node.js/Express + SQLite API: auth (JWT), library CRUD, progress sync, detection-rules remote config, tracker OAuth proxy | ✅ working, 500 integration tests |
